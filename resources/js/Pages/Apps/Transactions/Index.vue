<template>
    <Head>
        <title>Transactions - Mini Kasir</title>
    </Head>
    <main class="c-main">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-end">
                                    ...
                                    <button
                                        ...
                                        class="btn btn-danger btn-md border-0 shadow text-uppercase mt-3"
                                        :disabled="!product.id"
                                    >
                                        ADD ITEM
                                    </button>
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-end mt-4">
                                    ...
                                    <button
                                        ...
                                        class="btn btn-danger btn-md border-0 shadow text-uppercase"
                                        :disabled="
